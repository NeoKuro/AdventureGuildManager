...
public struct GuildMembershipData
{
    ...
    public SGuildDateTime   JoinDate       { get; private set; }
    ...
    {
        IsGuildMember  = false;
        JoinDate       = new SGuildDateTime(0, 0, 0, 0, 0);
    ...
    public GuildMembershipData(bool isGuildMember, SGuildDateTime joinDate, SAdventurerData adventurerData)
    {
